...
/**.
 * Class defines the fourth level of the game
 */
public class Level4 implements LevelInformation {
    private static final int HEIGHT_BLOCK = 20;
    private static final int WIDTH_BLOCK = 40;
    ...
    public List<Block> blocks() {
        ...
        int count = 0;
        for (int i = 100; i < 220; i += HEIGHT_BLOCK) {
    ...
    public List<Ball> balls() {
        ...
        Ball ball3 = new Ball(400, 400, 5, Color.white);
        ball3.setVelocity(initialBallVelocities().get(2));
        balls.add(ball1);
        balls.add(ball2);
        balls.add(ball3);
//        for (int i = 0; i < 50; i++) {
